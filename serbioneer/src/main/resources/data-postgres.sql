...
--email = krsmanija.backalic@email.com password = 1798
insert into users (type, name, surname, email, password, is_active, birthday)
values ('Admin', 'Krsmanija', 'Bačkalić', 'krsmanija.backalic@email.com', '$2b$12$UicZorLOnR8lY./I4rSL5OQRocCebGBl6sAgt/5J3oPkOaKdEIXGW', 'true', '1996-07-22');
insert into user_authority (user_id, authority_id) values (7, 1);

--email = isidor.zlicic@email.com password = 1241
insert into users (type, name, surname, email, password, is_active, birthday)
values ('Admin', 'Isidor', 'Zličić', 'isidor.zlicic@email.com', '$2b$12$X7w1N6WlJjRWEW.MuD0xnOmn4rvYOGVH8E/baHo2TKU3Ava2sX7q.', 'true', '1961-12-20');
insert into user_authority (user_id, authority_id) values (8, 1);

--email = adam.zavisic@email.com password = 4317
insert into users (type, name, surname, email, password, is_active, birthday)
values ('Admin', 'Adam', 'Zavišić', 'adam.zavisic@email.com', '$2b$12$kkzxvTVKmh6Bi72zOnPNjuaDiUFKgjVqRFwm.oOS8OEBlBwKJZwgm', 'true', '1939-08-14');
insert into user_authority (user_id, authority_id) values (9, 1);

--email = slobodan.ciculic@email.com password = 5937
insert into users (type, name, surname, email, password, is_active, birthday)
values ('Admin', 'Slobodan', 'Čičulić', 'slobodan.ciculic@email.com', '$2b$12$BMbbZ9Zy93E8vHJ4QLzGmO0lGNzVg6QK8NM/ep8y6GnAc1zkhVsL6', 'true', '1992-09-20');
insert into user_authority (user_id, authority_id) values (10, 1);

--email = svetislava.predic@email.com password = 8631
insert into users (type, name, surname, email, password, is_active, birthday)
values ('Admin', 'Svetislava', 'Predić', 'svetislava.predic@email.com', '$2b$12$l6mdw6Zrxk2aHnKtgqEhsut1Oy65eptSPawuWnzvXMvM.odQUxqHa', 'true', '1961-03-25');
insert into user_authority (user_id, authority_id) values (11, 1);

--email = stamena.ciplic@email.com password = 6485
insert into users (type, name, surname, email, password, is_active, activated)
values ('AuthenticatedUser', 'Stamena', 'Čiplić', 'stamena.ciplic@email.com', '$2b$12$FFNU5BWtZDqz5Wq2/JyuKe1ZT56T62SHYPPCTH4J2wcSdtem3ATyC', 'true', 'true');
insert into user_authority (user_id, authority_id) values (12, 2);

--email = sibinka.porobic@email.com password = 9268
insert into users (type, name, surname, email, password, is_active, activated)
values ('AuthenticatedUser', 'Sibinka', 'Porobić', 'sibinka.porobic@email.com', '$2b$12$Z2sPt8QRr1mVRaDg5tf0h.KzLe8JSQeqFYhM5bFX83cO7gxuQYsnS', 'true', 'true');
insert into user_authority (user_id, authority_id) values (13, 2);

--email = strahinja.parivodic@email.com password = 1735
insert into users (type, name, surname, email, password, is_active, activated)
values ('AuthenticatedUser', 'Strahinja', 'Parivodić', 'strahinja.parivodic@email.com', '$2b$12$MxkbTTzpeyNnOCQt.anzwOhlVE.T5vTvgd0YQaJaK8O.piSvKvPOy', 'true', 'true');
insert into user_authority (user_id, authority_id) values (14, 2);

--email = gabrijela.radisic@email.com password = 5133
insert into users (type, name, surname, email, password, is_active, activated)
values ('AuthenticatedUser', 'Gabrijela', 'Radišić', 'gabrijela.radisic@email.com', '$2b$12$5eYpW.eOy5ynWk9zTLN89OvdSH0E2Zu2YVkexy4mOSFE.N7C.LW4.', 'true', 'true');
insert into user_authority (user_id, authority_id) values (15, 2);

--email = negomir.gilic@email.com password = 5754
insert into users (type, name, surname, email, password, is_active, activated)
values ('AuthenticatedUser', 'Negomir', 'Gilić', 'negomir.gilic@email.com', '$2b$12$50O.woUjr/f5GJWztRbDkufQxHCaabShQfJ3x50lui7jf.FGAsXRi', 'true', 'true');
