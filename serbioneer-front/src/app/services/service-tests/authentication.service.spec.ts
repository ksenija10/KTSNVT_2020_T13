...
describe('Authentication service', () => {
    ...
    it('should fail to register new authenticated user - email already exists', fakeAsync(() => {
        ...
        let mockResponse: string = "User with given email already exists."
    ...
    it('should fail to log in user - invalid email', fakeAsync(() => {
        ...
        let mockError = 'Incorrect email or password.';
    ...
    it('should get no user logged in', () => {
        ...
        let token = authenticationService.getLoggedInUser();
    ...
    it('should return current logged in user role no user logged in', () => {
        ...
        let role: string = authenticationService.getLoggedInUserAuthority();
    ...
    it('should get current logged in user email', () => {
        ...
        let email: string = authenticationService.getLoggedInUserEmail();
